...
rm(BoxTaskDtD, DtDPart, IrrData, PartInp, Trial1, Trial2, Trial3, Trial4, Alt, boxchoice1, boxchoice2, boxchoice3, boxchoice4, color, data, i, id, keypress1, keypress2, keypress3, keypress4, keypressed, keypressed1, keypressed2, keypressed3, pressed1, pressed2, pressed3, pressed4, space, spacepressed, BoxTaskPathLog)
